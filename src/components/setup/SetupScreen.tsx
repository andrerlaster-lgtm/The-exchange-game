...
const QUICK_RULES = [
  ...
  'Circuit Breaker is a single held Market Event card. Play it during a later negative Market Event to protect 1 affected company you own from that card’s entire price drop, or keep it for later.',
