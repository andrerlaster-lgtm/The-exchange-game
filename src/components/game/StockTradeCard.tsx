...
// a player lands on a stock. Floats above the board as a fixed overlay (same
// treatment as CardDisplay's Fed/Market event card) so it's visible the
// instant it appears, with no scrolling to find it or to get back to the
// board afterward. Buying the landed stock (or the Free Trading Day list)
