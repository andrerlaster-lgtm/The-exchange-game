...
export const FED_CARDS: Card[] = [
  mk('Rate Hike', 'The Fed raises rates to fight inflation.', 'Finance UP 5% (500 bp) · Real Estate DOWN 5% (500 bp).', { k: 'multi', m: [{ sec: 'finance', bp: 500 }, { sec: 'realestate', bp: -500 }] }, 'hawkish', 'Banks gain a lending tailwind while property companies face higher borrowing costs.'),
  mk('Rate Cut', 'The Fed lowers rates to support spending.', 'Real Estate UP 5% (500 bp) · High-Risk UP 5% (500 bp).', { k: 'multi', m: [{ sec: 'realestate', bp: 500 }, { risk: 'High', bp: 500 }] }, 'dovish', 'Cheaper borrowing supports property demand and encourages investors to take more risk.'),
  ...
  mk('Tight Money', 'Credit conditions get stricter.', 'All High-Risk stocks move DOWN 5% (500 bp).', { k: 'risk', risk: 'High', bp: -500 }, 'hawkish', 'Harder financing creates a headwind for companies that depend on growth and risk appetite.'),
  mk('Easy Money', 'Borrowing conditions improve.', 'All High-Risk stocks move UP 5% (500 bp).', { k: 'risk', risk: 'High', bp: 500 }, 'dovish', 'Easier financing gives high-risk growth companies a market tailwind.'),
