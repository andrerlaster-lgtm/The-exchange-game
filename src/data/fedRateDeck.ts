...
export const FED_CARDS: Card[] = [
  ...
  mk('Mortgage Pressure', 'Higher borrowing costs hit housing demand and household budgets.', 'Real Estate DOWN 1 step · Consumer DOWN 1 step.', { k: 'multi', m: [{ sec: 'realestate', d: -1 }, { sec: 'consumer', d: -1 }] }, 'hawkish', 'Costlier mortgages weaken property demand and leave households with less money to spend.'),
  ...
  mk('Bond Yields Rise', 'Safer income investments get more attractive.', 'Low-Risk stocks UP 1 step · High-Risk stocks DOWN 1 step.', { k: 'multi', m: [{ risk: 'Low', d: 1 }, { risk: 'High', d: -1 }] }, 'hawkish', 'Investors rotate toward dependable income and away from speculative companies.'),
  mk('Cut Hopes Rally', 'Investors expect future cuts and chase growth.', 'Technology UP 1 step · Consumer UP 1 step.', { k: 'multi', m: [{ sec: 'tech', d: 1 }, { sec: 'consumer', d: 1 }] }, 'dovish', 'Expected rate relief increases demand for growth and consumer companies.'),
];
