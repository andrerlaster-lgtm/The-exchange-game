...
const CORE_ME_CARDS: Card[] = [
  ...
  mk('Bull Run',              'Investors rush back in after strong economic news.',         'High Risk +2, Medium Risk +1, Low Risk unchanged, revealed IPOs +1. Stance cash: Bullish +$1,500, Balanced +$500, Bearish −$750.', { k: 'regime', regime: 'bull' }),
  mk('Bear Run',              'Fear sends investors toward safety while risky assets sell off.', 'High Risk −2, Medium Risk −1, Low Risk +1, revealed IPOs −1. Stance cash: Bullish −$1,500, Balanced −$500, Bearish +$1,500.', { k: 'regime', regime: 'bear' }),
