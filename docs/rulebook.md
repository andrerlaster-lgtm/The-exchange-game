...
>
> **Status:** This rulebook is maintained alongside the playable prototype. A 2026-09-20 audit pass corrected the board counts (24 companies, 3 Market Event spaces, 2 Rate Decision spaces, 1 IPO space and 3 IPOs), replaced the retired 11 Sector Control pairs with the 9 within-sector groups, removed the last references to a $5,000 price ceiling that no longer exists, and dropped the Short Sell mention from Market Stance. The full-company landing rule and the $35,000 / $45,000 / $55,000 starting-cash choices are implemented. The 2026-09-18 reconciliation pass matched every rulebook-vs-code contradiction and undocumented mechanic found in the full-game audit (margin system, Weak/Strong Demand, Sold-Out payouts, Sector Control, player loans, the Market Meter, ETFs, and the sector map now all match the app exactly). A follow-up cash-flow pass the same day raised starting cash, salary, and dividend rates and added the Recovery Bonus (Section 8) after a live trace showed players being driven to $0 cash by Payout Claims. Items still explicitly marked TBD remain subject to balance testing.
...
- 4 ETF spaces/cards
- 1 IPO space, 2 Rate Decision spaces, and 3 IPO cards (shared reveal queue — see Section 19)
...
- Market price tracker, including the $100 floor marker and the $5,000 Market Event mark (a trigger, not a cap — Section 23)
...
- Sector Portfolio badges (8 sectors) and Sector Control group markers (9 groups, see Section 12)
...
- Place Payout Claim cards/markers, Weak Demand markers, Strong Demand markers, Sector Portfolio badges, Sector Control group markers, and Diversification badges near the bank.
...
|---|---|---|
| Regular stock | 24 | Buy shares, build ownership, sell out companies, create Payout Claims, earn dividends |
...
| IPO | 1 | Reveal and access IPO opportunities (shared queue of 3); space 11 |
| Rate Decision | 2 | Roll a d6 to set the Fed's move on the Bank Rate (Section 21); spaces 19 and 31 |
| Market Event | 3 | Draw and resolve a Market Event card; spaces 16, 29 and 40 |
| Market Open | 1 | Payday, Market Condition roll, then Market Open Trading Window |
| Portfolio Tax | 1 | Penalty space based on net worth; space 26 |
...
11. If the round just completed (every player has taken a turn), resolve the round-end market: the round's Market Theme lifts its tailwind sectors and presses its headwind sectors, by risk tier, across every public company (Section 21). Then draw the next round's theme.
...
| Toll Hike | Sector Control rent the owner collects, if they control a group, is doubled (a two-company group pays $400/$700; a three-company group $600/$1,050/$1,650). |
...
| Price ceiling | None. $5,000 is a one-way trigger, not a cap: crossing it upward on a trade draws a global Market Event (Section 23) |
...
- When a stock reaches 2 Weak Demand markers, move its market price down 5% immediately and clear the markers, unless the stock is already at the $100 floor.
...
Strong Demand is the positive mirror of Weak Demand: it gives an already sold-out, popular company its own ongoing upward price pressure, driven by repeat landings rather than by cards or the round-end market alone.
...
- When a company reaches 2 Strong Demand markers, move its market price up 5% immediately and clear the markers. There is no ceiling to stop it; crossing $5,000 upward draws a Market Event (Section 23).
...
Sector Control is a Monopoly-style "colour-set" bonus layered on top of the broader 8-sector Sector Portfolio system (Section 16). Sector Portfolio asks only for **1 share** of every company in a sector; Sector Control asks for **exclusive ownership** of a whole group — but it can fire on every qualifying landing, not just once per Market Open.

**Sector Control groups**

Every group sits inside **one sector**, so the colour blocks on the board are exactly the groups you can control (2026-09-20 — three earlier cross-sector pairs were retired). Healthcare has four companies and is the one sector that splits, into two groups of two.

| Group | Sector | Tier | Rent | Companies |
|---|---|---|---:|---|
| Consumer Staples | Consumer | Low | $300 | SafeMart (SAFE) · FreshBite (FRSH) · SneakerStreet (SNKR) |
| Health Essentials | Healthcare | Low | $200 | CarePlus Clinics (CARE) · VitalSign Devices (VSGN) |
| Health Innovation | Healthcare | Medium | $350 | MediCore Health (MEDI) · BioQuest Labs (BIOQ) |
| Energy Complex | Energy | Medium | $350 | OilWorks Energy (OILW) · SolarGrid Power (SOLR) |
| Real Estate Holdings | Real Estate | Medium | $525 | MetroHomes (MTRO) · TowerPoint (TWPT) · RentWell (RENT) |
| Heavy Industry | Industrials | Medium | $525 | IronRail (IRON) · BuildMax (BLDM) · AeroLift (AERO) |
| Media & Games | Comms/Media | Medium | $525 | StreamWave (STRM) · GameBox (GMBX) · Playbook Sports (PLBK) |
| Financial District | Finance | High | $825 | FirstTrust (FTRB) · PayWave (PAYW) · Apex (APEX) |
| Tech Sentinels | Technology | High | $825 | CloudCore AI (CCAI) · CyberShield (CYBS) · NovaMesh (NVMS) |

A three-company group is markedly harder to corner than a two-company one, so its rent is half as much again, rounded to $50.

**Sector Control rule**
- A player exclusively controls a group when they hold at least 1 share of *every* company in it and no other player holds any share of any of them.
- Because a full-company purchase is all-or-nothing (Section 7), the only landing where Sector Rent can apply is on an already Sold-Out company — in practice, control requires every company in the group to be sold out.
- When another player lands on any company in a group its controller exclusively owns, the controller's Sector Rent is added on top of the normal Payout Claim owed for that landing (Section 11). It is never charged on its own, and never on an untouched-company landing.
- If ownership of the group is split, tied, or only partially held, no Sector Rent applies. This is entirely separate from, and does not affect, any company's own individual Payout Claim holder.
...
|---|---|
| Total IPO companies | 3, in a single shared face-down reveal queue |
| IPO board spaces | 1 (space 11) — landing there triggers the next reveal |
...
The market moves **once per completed round**, and a **Market Theme** decides what it does. A single dice roll never moves prices — it moves that player's piece and nothing else.

**At the start of every round**

One Market Theme is drawn and announced. Each theme names **tailwind** sectors and **headwind** sectors:

| Theme | Tailwinds | Headwinds |
|---|---|---|
| Growth Rotation | Technology, Finance, Communications | Consumer, Real Estate |
| Defensive Rotation | Healthcare, Consumer, Real Estate | Technology, Communications |
| Energy Shock | Energy, Industrials | Consumer, Real Estate |
| Infrastructure Boom | Industrials, Energy, Finance | Consumer, Communications |
| Credit Tightening | Finance, Consumer | Technology, Real Estate |
| Healthcare Breakthrough | Healthcare, Technology | Energy, Consumer |

The theme is public the whole round, so everyone trades knowing what the close will reward. What nobody knows is how much of it each player will be able to act on before the round ends.

**End-of-round resolution**

Once every player has taken a turn:

1. Every **public** company in a tailwind sector **rises**; every public company in a headwind sector **falls**. A company is public once at least one of its shares has left the bank — an untouched company is not affected by a theme.
2. The size is **5%, scaled by risk tier**:
...
3. Sectors the theme does not name do not move at all.
4. The theme is spent, and a new one is drawn for the next round.
...
- Anything already at its limit in that direction simply does not move; nothing is substituted for it.
...
**In play:** "The theme is on the table all round: these sectors are favoured, these are under pressure. Trade into it before the round closes, because the close pays out on what you are holding then — and only companies that are already public move."
...
| Market Event — spaces 16, 29 and 40 | Draw and resolve 1 Market Event card. Also triggered automatically the first time any stock crosses $5,000 upward on a trade (Section 23). |
...
- Selling 3 or more shares in one bank sale or private trade sets **Bearish**.
...
| Round-end market move | Moves the round's Market Theme sectors, by risk tier; see Section 21 |
...
- Do not add separate value for Payout Claims, Sector Portfolio badges, Sector Control groups, or Controller badges unless a specific card/rule grants an endgame bonus.
...
| Sector Control | On (9 fixed within-sector groups) |
...
| Price floor / ceiling | On — $100 floor; no ceiling ($5,000 is a one-way Market Event trigger) |
...
| Derived state | Ownership tier, Controller, Sector Portfolio, Sector Control group ownership, Diversified Portfolio, Payout Claim, Contested state, Sold-Out state, Strong/Weak Demand markers, the round's Market Theme, active Market Condition, Margin balance, Player Loan balances, Outstanding Fees principal/interest, Circuit Breaker holder, remaining stock cost basis, realized/unrealized Stock G/L, salary-adjusted Market Gain |
...
| Round-end market | Draw a Market Theme as each round begins. At the end of every non-final round: public companies in tailwind sectors rise and in headwind sectors fall, 250/500/750 bp by Low/Med/High risk; untouched companies and unnamed sectors do not move; a single roll or a card never triggers it |
...
| UI | Show Sold Out, Payout Claim holder, landing payout, Contested status, Strong/Weak Demand marker counts, Sector Control group ownership, sector progress, diversification badge, the round's Market Theme, active Market Condition, held Circuit Breaker, Outstanding Share count, dividend income per Market Open, Margin balance, Player Loan balances, Outstanding Fees principal/interest/payment controls, per-holding basis and unrealized G/L, total realized/unrealized Stock G/L, Market Gain and salary excluded. Cardless financial spaces must show the total charge and Pay Now / Carry as Debt choices. |
| Logs | Separate bank payout, player-paid payout, private trade, full-company buy, bank sell-back, outstanding-share purchase, Weak/Strong Demand, Payout Claim transfer, Sector Rent, Player Loan issue/accrual/payment, dividend payout, Margin draw/repay, round-end Market Theme reprice, Market Condition start |
